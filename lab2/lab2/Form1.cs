    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (comboBox1.SelectedItem.ToString() == "y = mx + b")
            {
                ...
                float pendiente1Float = float.Parse(pendiente1);
                float pendiente2Float = float.Parse(pendiente2);
                float intercep1Float = float.Parse(intercep1);
                float intercep2Float = float.Parse(intercep2);
